...
import com.github.ccphamy.common.utils.FileUploadUtils;
import com.github.ccphamy.common.utils.FileUtils;
import com.github.ccphamy.common.utils.R;
import com.github.ccphamy.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = "uploadPath/download/" + fileName;
    ...
    public R uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = "uploadPath/upload";
            // 上传并返回新文件名称
