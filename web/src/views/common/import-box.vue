    ...
    <div>
        <el-dialog width="500px" title="导入Excel" :close-on-click-modal="false" :visible.sync="visible">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-checkbox :disabled="load" v-model="updateSupport"
                             style="margin-right: 10px;font-size: 12px">替换已存在数据</el-checkbox>
...
export default {
    ...
    methods: {
        ...
        submitUpload() {
            this.tmpAction = `${this.action}?updateSupport=` + this.updateSupport
            // load
            this.load = true
            this.$nextTick(() => {
